  ...
  module AttachmentFu # :nodoc:
    ...
    module ActMethods
      ...
      def has_attachment(options = {})
        ...
        attachment_options[:path_prefix]   = attachment_options[:path_prefix][1..-1] if options[:path_prefix].start_with?('/') 
    ...
    module ClassMethods
      ...
      # Copies the given file path to a new tempfile, tap the closed tempfile.
      ...
      # Writes the given data to a new tempfile, tap the closed tempfile.
